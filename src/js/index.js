...
Routers.map('/index',function(transition){
  Routers.syncFun(function(transition){
	$("#code").load("html/home.html");
  },transition)
})
Routers.map('/home2',function(transition){
  Routers.syncFun(function(transition){
	$("#code").load("html/home2.html");
  },transition)
})
//document.body.appendChild(component());